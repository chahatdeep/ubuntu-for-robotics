#!/bin/bash
# Script for Installing OpenCV v3.3. Can be adapted for other versions as well.
...
read -p "Press <ENTER> to continue"
echo "Removing any pre-installed ffmpeg and x264 packages that have issues with CV2"
...
# Use this for picking a specific verion, may not work!
#wget -O OpenCV-$version.zip http://sourceforge.net/projects/opencvlibrary/files/opencv-unix/$version/opencv-"$version".zip/download

# Overwrite opencv version with a specific online version: 
